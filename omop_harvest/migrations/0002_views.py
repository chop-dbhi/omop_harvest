...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding views of almanac Element model as Harvest endpoints for project hierarchy relationships
        old_colors = os.environ.get('DJANGO_COLORS', '')
        os.environ['DJANGO_COLORS'] = 'nocolor'
        sql = StringIO()
        call_command('sqlcustom', 'omop_harvest', stdout=sql)
        db.execute(sql.getvalue())
        os.environ['DJANGO_COLORS'] = old_colors
