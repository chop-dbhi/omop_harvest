...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DrugConcept'
        db.create_table(u'drug_concept', (
        ...
        db.send_create_signal(u'omop_harvest', ['DrugConcept'])

        # Adding model 'ObservationValue'
        db.create_table(u'observation_value', (
            ('concept_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('concept_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('concept_level', self.gf('django.db.models.fields.DecimalField')(max_digits=38, decimal_places=0)),
            ('concept_class', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ...
        db.send_create_signal(u'omop_harvest', ['ObservationValue'])

        # Adding model 'DrugType'
        db.create_table(u'drug_type', (
            ('concept_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('concept_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('concept_level', self.gf('django.db.models.fields.DecimalField')(max_digits=38, decimal_places=0)),
            ('concept_class', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ...
        db.send_create_signal(u'omop_harvest', ['DrugType'])

        # Adding model 'ObservationCondition'
        db.create_table(u'observation_condition', (
            ('concept_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('concept_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('concept_level', self.gf('django.db.models.fields.DecimalField')(max_digits=38, decimal_places=0)),
            ('concept_class', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ...
        db.send_create_signal(u'omop_harvest', ['ObservationCondition'])

        # Adding model 'DrugCondition'
        db.create_table(u'drug_condition', (
            ('concept_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('concept_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('concept_level', self.gf('django.db.models.fields.DecimalField')(max_digits=38, decimal_places=0)),
            ('concept_class', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ...
        db.send_create_signal(u'omop_harvest', ['DrugCondition'])


        # Changing field 'DrugExposure.relevant_condition_concept_id'
        db.alter_column(u'drug_exposure', u'relevant_condition_concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omop_harvest.DrugCondition'], null=True, db_column=u'relevant_condition_concept_id'))
        # Adding index on 'DrugExposure', fields ['relevant_condition_concept_id']
        db.create_index(u'drug_exposure', [u'relevant_condition_concept_id'])


        # Changing field 'DrugExposure.drug_type_concept_id'
        db.alter_column(u'drug_exposure', u'drug_type_concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omop_harvest.DrugType'], db_column=u'drug_type_concept_id'))
        # Adding index on 'DrugExposure', fields ['drug_type_concept_id']
        db.create_index(u'drug_exposure', [u'drug_type_concept_id'])


        # Changing field 'DrugExposure.drug_concept_id'
        db.alter_column(u'drug_exposure', u'drug_concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omop_harvest.DrugConcept'], db_column=u'drug_concept_id'))
        # Adding index on 'DrugExposure', fields ['drug_concept_id']
        db.create_index(u'drug_exposure', [u'drug_concept_id'])


        # Changing field 'Observation.relevant_condition_concept_id'
        db.alter_column(u'observation', u'relevant_condition_concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omop_harvest.ObservationCondition'], null=True, db_column=u'relevant_condition_concept_id'))
        # Adding index on 'Observation', fields ['relevant_condition_concept_id']
        db.create_index(u'observation', [u'relevant_condition_concept_id'])


        # Changing field 'Observation.value_as_concept_id'
        db.alter_column(u'observation', u'value_as_concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omop_harvest.ObservationValue'], null=True, db_column=u'value_as_concept_id'))
        # Adding index on 'Observation', fields ['value_as_concept_id']
        db.create_index(u'observation', [u'value_as_concept_id'])


    def backwards(self, orm):
        # Removing index on 'Observation', fields ['value_as_concept_id']
        db.delete_index(u'observation', [u'value_as_concept_id'])

        # Removing index on 'Observation', fields ['relevant_condition_concept_id']
        db.delete_index(u'observation', [u'relevant_condition_concept_id'])

        # Removing index on 'DrugExposure', fields ['drug_concept_id']
        db.delete_index(u'drug_exposure', [u'drug_concept_id'])

        # Removing index on 'DrugExposure', fields ['drug_type_concept_id']
        db.delete_index(u'drug_exposure', [u'drug_type_concept_id'])

        # Removing index on 'DrugExposure', fields ['relevant_condition_concept_id']
        db.delete_index(u'drug_exposure', [u'relevant_condition_concept_id'])

        # Deleting model 'DrugConcept'
        db.delete_table(u'drug_concept')

        # Deleting model 'ObservationValue'
        db.delete_table(u'observation_value')

        # Deleting model 'DrugType'
        db.delete_table(u'drug_type')

        # Deleting model 'ObservationCondition'
        db.delete_table(u'observation_condition')

        # Deleting model 'DrugCondition'
        db.delete_table(u'drug_condition')


        # Changing field 'DrugExposure.relevant_condition_concept_id'
        db.alter_column(u'drug_exposure', 'relevant_condition_concept_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DrugExposure.drug_type_concept_id'
        db.alter_column(u'drug_exposure', 'drug_type_concept_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DrugExposure.drug_concept_id'
        db.alter_column(u'drug_exposure', 'drug_concept_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Observation.relevant_condition_concept_id'
        db.alter_column(u'observation', 'relevant_condition_concept_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Observation.value_as_concept_id'
        db.alter_column(u'observation', 'value_as_concept_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    models = {
        u'omop_harvest.caresite': {
            'Meta': {'object_name': 'CareSite', 'db_table': "u'care_site'"},
            'care_site_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.cohort': {
            ...
            'cohort_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.conditionera': {
            ...
            'condition_era_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.conditionoccurrence': {
            ...
            'condition_occurrence_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.drugconcept': {
            'Meta': {'object_name': 'DrugConcept', 'db_table': "u'drug_concept'"},
            'concept_class': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'concept_code': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'concept_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'concept_level': ('django.db.models.fields.DecimalField', [], {'max_digits': '38', 'decimal_places': '0'}),
        ...
        u'omop_harvest.drugcondition': {
            'Meta': {'object_name': 'DrugCondition', 'db_table': "u'drug_condition'"},
            'concept_class': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'concept_code': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'concept_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'concept_level': ('django.db.models.fields.DecimalField', [], {'max_digits': '38', 'decimal_places': '0'}),
        ...
        u'omop_harvest.drugcost': {
            ...
            'drug_cost_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.drugera': {
            ...
            'drug_era_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.drugexposure': {
            ...
            'drug_concept_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.DrugConcept']", 'db_column': "u'drug_concept_id'"}),
            'drug_exposure_end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'drug_exposure_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'drug_type_concept_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.DrugType']", 'db_column': "u'drug_type_concept_id'"}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.Person']"}),
            ...
            'relevant_condition_concept_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.DrugCondition']", 'null': 'True', 'db_column': "u'relevant_condition_concept_id'", 'blank': 'True'}),
        ...
        u'omop_harvest.drugtype': {
            'Meta': {'object_name': 'DrugType', 'db_table': "u'drug_type'"},
            'concept_class': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'concept_code': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'concept_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'concept_level': ('django.db.models.fields.DecimalField', [], {'max_digits': '38', 'decimal_places': '0'}),
        ...
        u'omop_harvest.observation': {
            ...
            'observation_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'relevant_condition_concept_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.ObservationCondition']", 'null': 'True', 'db_column': "u'relevant_condition_concept_id'", 'blank': 'True'}),
            ...
            'value_as_concept_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.ObservationValue']", 'null': 'True', 'db_column': "u'value_as_concept_id'", 'blank': 'True'}),
        ...
        u'omop_harvest.observationcondition': {
            'Meta': {'object_name': 'ObservationCondition', 'db_table': "u'observation_condition'"},
            'concept_class': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'concept_code': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'concept_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'concept_level': ('django.db.models.fields.DecimalField', [], {'max_digits': '38', 'decimal_places': '0'}),
        ...
        u'omop_harvest.observationperiod': {
            ...
            'observation_period_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.observationvalue': {
            'Meta': {'object_name': 'ObservationValue', 'db_table': "u'observation_value'"},
            'concept_class': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'concept_code': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'concept_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'concept_level': ('django.db.models.fields.DecimalField', [], {'max_digits': '38', 'decimal_places': '0'}),
        ...
        u'omop_harvest.organization': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.Location']", 'null': 'True', 'blank': 'True'}),
            'organization_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.payerplanperiod': {
            ...
            'payer_plan_period_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.procedurecost': {
            ...
            'paid_toward_deductible': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'payer_plan_period': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['omop_harvest.PayerPlanPeriod']", 'null': 'True', 'blank': 'True'}),
            'procedure_cost_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.procedureoccurrence': {
            ...
            'procedure_occurrence_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.provider': {
            ...
            'provider_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'omop_harvest.visitoccurrence': {
            ...
            'visit_occurrence_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
