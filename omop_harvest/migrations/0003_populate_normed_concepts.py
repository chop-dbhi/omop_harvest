...
from omop_harvest.models import (Gender, Race, Ethnicity, ConditionConcept,
                                 ConditionType, ProcedureConcept, ProcedureType,
                                 ObservationConcept, ObservationType)
new_models = [Gender, Race, Ethnicity, ConditionConcept, ConditionType,
              ProcedureConcept, ProcedureType, ObservationType]
